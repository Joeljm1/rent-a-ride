      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border border-gray-200 dark:border-gray-700">
          ...
          <div className="p-12 text-center space-y-6">
            <h1 className="text-8xl font-extrabold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4 tracking-tighter">
              404
            </h1>
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 tracking-tight">
              Page Not Found
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-md mx-auto font-normal leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900/50 dark:to-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mt-8">
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-4 font-semibold tracking-wide">
                Here are some helpful links instead:
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link 
                  to="/"
                  className="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 transition-all duration-300 hover:scale-105 text-sm font-medium"
                >
                  🏠 Home
                </Link>
                <Link 
            ...
            <Link 
              to="/"
              className="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl hover:shadow-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-lg mt-6 text-lg tracking-wide"
            >
              Take Me Home
            </Link>
          </div>
